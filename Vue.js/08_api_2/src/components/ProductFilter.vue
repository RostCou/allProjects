    ...
    <aside class="filter">
        ...
        <form class="filter__form form" action="#" method="get" @submit.prevent="submit">
            ...
            <fieldset class="form__block">
                ...
                <ColorList v-if="colorsloading" class="colors" :mass-colors="colorsList"
                    :current-color-selected.sync="currentColor" :name="'filterColors'" />
            </fieldset>
...
export default {
    ...
    methods: {
        submit() {
            ...
            this.$emit("update:color", this.colorsData.find(color => color.code === this.currentColor).id);
        },
        reset() {
        ...
        loadColors() {
            axios.get(API_BASE_URL + "/api/colors")
                .then(response => {
                    ...
                    this.currentColor = this.colorsData[0].code;
