<template>
    ...
    <main class="content container" v-else-if="!productData">не удалось загрузть товар</main>
                ...
                <div class="item__form">
                    <form class="form" action="#" method="POST" @submit.prevent="addCart">
                        ...
                        <fieldset class="form__block">
                            ...
                            <ColorList class="colors" :mass-colors="product.colors" :name="'product_' + product.id" />
                        </fieldset>
                        ...
                        <div class="item__row">
                            ...
                            <ProductCount class="form__counter" :value.sync="productAmount" />
...
export default {
    ...
    components: { ColorList, ProductCount },
    computed: {
        product() {
