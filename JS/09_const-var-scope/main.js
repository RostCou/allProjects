(() => {
      ...
      newLi.addEventListener("click", function handlerClick() {
        ...
        if (arrTemp.length <= 1) {
          ...
          if (finalGame === (objCardArr.length - 2)) {
            ...
            document.getElementById(arrTemp[0].id).firstChild.textContent = arrTemp[0].card;
            document.getElementById(arrTemp[1].id).firstChild.textContent = arrTemp[0].card;
          ...
          if (arrTemp[0].card === arrTemp[1].card) {
            ...
            document.getElementById(arrTemp[0].id).addEventListener("click", handlerClick)
            document.getElementById(arrTemp[1].id).addEventListener("click", handlerClick)
            arrTemp.pop();
            arrTemp.pop();
            arrTemp.push(objCardArr[this.id - 1])
          }
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    input.addEventListener("submit", e => {
      ...
      if ((parseInt(inputNumber.value) % 2 === 0) && ((parseInt(inputNumber.value) >= 2) && (parseInt(inputNumber.value) <= 10))) {
